...
class DatatransHelper {
   ...
   * @param string|int $transaction_reference
   *   Our reference number.
   *
   * @return string
   *   The computed hash.
   */
  public static function generateSign($hmac_key, $merchant_id, $amount, $currency, $transaction_reference) {
    $hmac_data = $merchant_id . $amount . $currency . $transaction_reference;
